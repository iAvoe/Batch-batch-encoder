...
::「Debug」Comment out with REM (+compatiblity with precentage signs) during normal encodes
REM @echo %ffmpegParA%
REM @echo %ffmpegVarA%
...
::Choose 「y:Continue/n:Pause/z:END」Auto-continue after 5s, false input are blocked by choice statement, pause allows continue. This comment needs to be lifted 1 line above commands below to prevent weird issues
...
::Choose 「y:Continue/n:Pause/z:END」Continuing after 5s sleep, false input are blocked by choice statement, pause allows continue. This comment needs to leave extra blank from commands below to prevent weird issues
