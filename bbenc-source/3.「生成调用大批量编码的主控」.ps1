...
REM 「debug与测试」x265变化参数, 平时注释掉, 末尾不加空格

REM @set `"x265VarAAA=--crf 23 ... --output ...`"
REM @set `"x265VarAAB=--crf 26 ... --output ...`"
REM @set `"x264VarAAA=--crf 23 ... --output ...`"
REM @set `"x264VarAAB=--crf 26 ... --output ...`"
